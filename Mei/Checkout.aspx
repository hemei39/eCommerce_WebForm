<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="Mei.Checkout" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ObjectDataSource ID="srcCheckout" runat="server" SelectMethod="GetShoppingCart"
        TypeName="Mei.Models.BLL"></asp:ObjectDataSource>
    <p>
