<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default1.aspx.cs" Inherits="eCommerce.Default1" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <div style="float: left; margin-right: 50px;">
            ...
            <asp:ObjectDataSource ID="srcCategories" runat="server" SelectMethod="GetCategories" TypeName="eCommerceModels.BLL"></asp:ObjectDataSource>
            <asp:ObjectDataSource ID="srcProducts" runat="server" SelectMethod="GetProducts"
                TypeName="eCommerceModels.BLL" SortParameterName="sortColumn">
                <SelectParameters>
